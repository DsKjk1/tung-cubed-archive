...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TUNG TUNG TUNG SAHUR CLASS — IGCSE Edexcel CS: Issues & Impact" },
      { property: "og:description", content: "Interactive underground archive for IGCSE Edexcel Computer Science: Issues & Impact." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "TUNG TUNG TUNG SAHUR CLASS — IGCSE Edexcel CS: Issues & Impact" },
      { name: "twitter:description", content: "Interactive underground archive for IGCSE Edexcel Computer Science: Issues & Impact." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b2fa7c27-f6e6-49bc-ad31-b67b3636704d" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b2fa7c27-f6e6-49bc-ad31-b67b3636704d" },
